      ...
      >
        <div className="bg-white rounded-[3rem] p-8 md:p-12 premium-shadow border border-gray-100">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-black text-secondary tracking-tighter mb-2">Create Account</h1>
            <p className="text-gray-400 font-bold text-sm">Join our community and discover your true potential.</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-2">
                <label className="text-xs font-black text-secondary uppercase tracking-widest ml-4">Full Name</label>
              ...
              <div className="space-y-2">
                <label className="text-xs font-black text-secondary uppercase tracking-widest ml-4">Phone Number</label>
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none text-gray-400 group-focus-within:text-primary transition-colors">
                    <Phone size={20} />
                  </div>
            ...
            <div className="space-y-2">
              <label className="text-xs font-black text-secondary uppercase tracking-widest ml-4">Password</label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none text-gray-400 group-focus-within:text-primary transition-colors">
                  <Lock size={20} />
                </div>
            ...
            <div className="flex items-start gap-3 px-4 pt-2">
              <input type="checkbox" className="mt-1 accent-primary w-4 h-4" id="terms" />
              <label htmlFor="terms" className="text-xs font-bold text-gray-400 leading-relaxed">
                I agree to the <Link to="#" className="text-secondary hover:underline">Terms of Service</Link> and <Link to="#" className="text-secondary hover:underline">Privacy Policy</Link>.
              </label>
            </div>
