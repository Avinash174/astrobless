    ...
    <div className="min-h-screen bg-primary-bg flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 font-medium">Log in to your cosmic account</p>
        </div>
        ...
        <div className="glass-card p-8 md:p-10">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                <Link to="/forgot-password" title="Forgot Password" className="text-[10px] font-black text-accent uppercase tracking-widest hover:underline">Forgot?</Link>
              </div>
              <div className="relative group">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-[10px] font-black uppercase tracking-widest">
              <span className="bg-[#121808] px-4 text-gray-600">Or continue with</span>
            </div>
          </div>

          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-3 bg-white/[0.03] border border-white/10 py-3.5 rounded-2xl text-xs font-black text-white hover:bg-white/10 transition-all group">
            ...
            <button className="flex items-center justify-center gap-3 bg-white/[0.03] border border-white/10 py-3.5 rounded-2xl text-xs font-black text-white hover:bg-white/10 transition-all group">
              <svg className="w-4 h-4 fill-white group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
                <path d="M17.05 20.28c-.96 0-2.04-.55-3.08-.55-1.07 0-2.03.54-3.01.54-1.58 0-4.14-2.8-4.14-5.63 0-2.73 1.83-4.18 3.58-4.18.91 0 1.76.54 2.51.54.71 0 1.69-.58 2.76-.58 1.41 0 3.05.81 3.86 2.05-2.79 1.34-2.33 4.93.42 6.08-.63 1.49-1.56 3.15-2.9 3.18zM12.03 9.41c.03-2.31 1.91-4.16 4.21-4.13.06 2.37-2.03 4.31-4.21 4.13z"/>
              </svg>
              Apple
            </button>
          </div>
        ...
        <p className="text-center mt-8 text-sm text-gray-500 font-medium">
          ...
          <Link to="/signup" className="text-accent font-black hover:underline uppercase tracking-widest text-xs ml-1">
            Create Account
          </Link>
        </p>
      </motion.div>
